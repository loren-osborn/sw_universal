...
// This file intentionally stays tiny: it validates the shared pack-index utility
// both in isolation and in the style used by nearby internal components.
...
/// @brief Verifies direct pack-element selection at a few representative indices.
...
/// @brief Verifies the utility works with the same field-spec packs used by `bitfield_pack`.
