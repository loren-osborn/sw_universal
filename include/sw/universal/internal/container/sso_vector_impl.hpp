...
#ifndef SW_UNIVERSAL_SSO_VECTOR_ENABLE_COW
#error "sso_vector_impl.hpp must be included through a configured wrapper"
#endif
#ifndef SW_UNIVERSAL_SSO_VECTOR_NAMESPACE_OPEN
#error "sso_vector_impl.hpp must be included through a configured wrapper"
#endif
#ifndef SW_UNIVERSAL_SSO_VECTOR_NAMESPACE_CLOSE
#error "sso_vector_impl.hpp must be included through a configured wrapper"
#endif
#ifndef SW_UNIVERSAL_SSO_VECTOR_IF_COW_ENABLED
#error "sso_vector_impl.hpp must be included through a configured wrapper"
#endif
#ifndef SW_UNIVERSAL_SSO_VECTOR_IF_COW_DISABLED
#error "sso_vector_impl.hpp must be included through a configured wrapper"
#endif
...
SW_UNIVERSAL_SSO_VECTOR_IF_COW_ENABLED(
template<typename T, std::size_t N, typename Allocator = std::allocator<T>,
         zero_inline_policy ZeroInlinePolicy = zero_inline_policy::disallow>
...
SW_UNIVERSAL_SSO_VECTOR_NAMESPACE_CLOSE
