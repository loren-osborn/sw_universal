...
private:
	...
	template<typename BBlockType, typename BBlockContainer>
	friend constexpr bool operator==(const einteger<BBlockType, BBlockContainer>&, const einteger<BBlockType, BBlockContainer>&) noexcept;
};
...
template<typename BlockType, typename BlockContainer>
constexpr bool operator==(const einteger<BlockType, BlockContainer>& lhs, const einteger<BlockType, BlockContainer>& rhs) noexcept {
